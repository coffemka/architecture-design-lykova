...
![Системный контекст](./c4_context_final.png)
...
![Контейнеры системы](./c4_container_final.png)
...
![Компоненты сервиса студентов](./c4_components_student.png)
...
**2. Управление расписанием**  Административный компонент для создания, редактирования и отмены слотов консультаций.
